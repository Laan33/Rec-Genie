...
\begin{itemize}
    ...
    \item \textbf{recommendation Module}:
    \subitem \textbf{RecSys}: Collaborative and content-based filtering recommendations.
    ...
    \item \textbf{Sentiment Weighting Calculator}: Takes sentiment analysis and adjusts users weighting scheme accordingly. 
    
    \item \textbf{Next Action Module}: Based on the user's messages and the system's current state, the module decides on what action to do next.
