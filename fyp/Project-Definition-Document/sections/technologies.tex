...
\begin{itemize}
    ...
    \item \textbf{Twitter-roBERTa-base for Sentiment Analysis}: NLP RoBERTa model\cite{camacho-collados-etal-2022-tweetnlp} for sentiment analysis. I will be using this model to extract sentiment from user responses.
...
\begin{itemize}
    \item \textbf{ML-1000k}: 
    This dataset\cite{10.1145/2827872} contains 100,000 ratings (ranging in 1-5) from 943 users on 1682 movies. 
    ...
    \item \textbf{RecDial}: 
    \item \textbf{DuRecDial}:
    \item \textbf{TG-ReDial}: TG-ReDial\cite{zhou2020topicguided} is a topic guided version of the ReDial dataset
\end{itemize}
