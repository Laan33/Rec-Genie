\begin{table}[H]
   \centering
   \begin{tabular}{|p{3cm}|p{11cm}|} % Adjusted column widths
   \hline
   ...
   \end{tabular}
   \caption{Film Chat Explore and Explain Recommendation Prompt}
   \label{tab:llm_prompts_chat_explain}
   \end{table}
...
\begin{table}[H]
   ...
   \end{tabular}
   \caption{Glean Feedback Prompt}
   \label{tab:llm_prompts_glean_feedback}
   \end{table}