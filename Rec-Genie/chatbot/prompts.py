...
glean_feed_back_chain = PromptTemplate(
    ...
    template=(
        ...
        "FORMAT THE OUTPUT EXACTLY LIKE THIS EXAMPLE, ONLY USE ITEMS MENTIONED IN THE USER MESSAGE OR DIRECTLY RELATED TO MENTIONED ITEMS: "
        "Directors; 0.9, Christopher Nolan: 0.9, Wes Anderson: 0.4 \n"
        "Films; 1.0, Interstellar: 0.8, Inception: 0.8, Fantastic Mr Fox: 0.7 \n"
        ...
        "3. Include categories and items explicitly mentioned in the message\n"
        "4. Also include implied items not directly mentioned but associated with mentioned items:\n"
        ...
        "7. Use negative scores (-0.1 to -0.5) for things the user expressly dislikes\n"
        "8. IF AN ITEM IS MENTIONED BUT NO CLEAR SENTIMENT IS GIVEN, DEFAULT TO 0.2\n"
        ...
        "    (e.g., if a film has 0.8 score, its director gets 0.8 × 0.6 = 0.48)\n"
        "\n"
